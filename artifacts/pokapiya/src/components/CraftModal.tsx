...
const RECIPES: Recipe[] = [
  {
    ...
    name: 'Wooden Fence',
    emoji: '🪵',
    description: 'Crafted from lumber. Pokémon love a tidy yard.',
    cost: '2 🪵 Lumber',
    reward: '+3 🪙',
  },
  {
    ...
    emoji: '🪨',
    description: 'A polished stone walkway.',
    cost: '2 🪨 Stone',
    reward: '+3 🪙',
  },
  {
    ...
    name: 'Berry Tree',
    emoji: '🌳',
    description: 'A berry seed in fresh-cut lumber sprouts a tree.',
