// Pokedex slice 1: first 150 Pokemon (Kanto). Sprite served from PokeAPI public sprite repo.
// Types drive which STEM question bank is used during a catch attempt.
...
// [id, Name, [primaryType, secondaryType?], rarityTier(1=common..3=rare)]
export const KANTO = [
  ...
  [143,'Snorlax',['normal'],3],
  [144,'Articuno',['ice','flying'],3],[145,'Zapdos',['electric','flying'],3],[146,'Moltres',['fire','flying'],3],
  [147,'Dratini',['dragon'],3],[148,'Dragonair',['dragon'],3],[149,'Dragonite',['dragon','flying'],3],
...
export function pickRandom() {
  // Weighted toward common (rarity 1), then 2, then 3.
...
// Helper: name with first letter cap and hyphen handling for display.
